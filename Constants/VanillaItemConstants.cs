...
{
    public static readonly List<MongoId> VanillaButtPads = new()
    {
    ...
    public static readonly List<MongoId> WeaponsWithNoSmallMagazines = new()
    {
    ...
    public static readonly List<MongoId> LabyrinthKeys = new()
    {
